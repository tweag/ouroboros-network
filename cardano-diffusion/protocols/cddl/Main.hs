...
import Cardano.Network.Protocol.BlockFetch.Codec (codecBlockFetch)
import Cardano.Network.Protocol.BlockFetch.Codec.CDDL
import Cardano.Network.Protocol.BlockFetch.Test ()
import Cardano.Network.Protocol.BlockFetch.Type (BlockFetch)
import Cardano.Network.Protocol.BlockFetch.Type qualified as BlockFetch
import Cardano.Network.Protocol.ChainSync.Codec (codecChainSync)
import Cardano.Network.Protocol.ChainSync.Codec.CDDL
import Cardano.Network.Protocol.ChainSync.Test ()
import Cardano.Network.Protocol.ChainSync.Type (ChainSync)
import Cardano.Network.Protocol.ChainSync.Type qualified as ChainSync
import Cardano.Network.Protocol.Handshake.Codec (nodeToClientHandshakeCodec,
           nodeToNodeHandshakeCodec)
-- import Cardano.Network.Protocol.Handshake.Test (VersionNumber, versionNumberHandshakeCodec)
import Cardano.Network.Protocol.Handshake.Type (Handshake)
import Cardano.Network.Protocol.Handshake.Type qualified as Handshake
import Cardano.Network.Protocol.KeepAlive.Codec (codecKeepAlive_v2)
import Cardano.Network.Protocol.KeepAlive.Test ()
import Cardano.Network.Protocol.KeepAlive.Type (KeepAlive)
import Cardano.Network.Protocol.KeepAlive.Type qualified as KeepAlive
import Cardano.Network.Protocol.LocalStateQuery.Codec (codecLocalStateQuery)
import Cardano.Network.Protocol.LocalStateQuery.Codec qualified as LocalStateQuery
import Cardano.Network.Protocol.LocalStateQuery.Codec.CDDL
import Cardano.Network.Protocol.LocalStateQuery.Test qualified as LocalStateQuery
import Cardano.Network.Protocol.LocalStateQuery.Type (LocalStateQuery)
import Cardano.Network.Protocol.LocalStateQuery.Type qualified as LocalStateQuery
import Cardano.Network.Protocol.LocalTxMonitor.Codec (codecLocalTxMonitor)
import Cardano.Network.Protocol.LocalTxMonitor.Codec.CDDL
import Cardano.Network.Protocol.LocalTxMonitor.Test qualified as LocalTxMonitor
import Cardano.Network.Protocol.LocalTxMonitor.Type (LocalTxMonitor)
import Cardano.Network.Protocol.LocalTxMonitor.Type qualified as LocalTxMonitor
import Cardano.Network.Protocol.LocalTxSubmission.Codec (codecLocalTxSubmission)
import Cardano.Network.Protocol.LocalTxSubmission.Codec.CDDL
...
import Cardano.Network.Protocol.ObjectDiffusion.Test ()
...
import Cardano.Network.Protocol.TxSubmission2.Codec (codecTxSubmission2)
import Cardano.Network.Protocol.TxSubmission2.Codec.CDDL
import Cardano.Network.Protocol.TxSubmission2.Test (Tx, TxId)
import Cardano.Network.Protocol.TxSubmission2.Type (TxSubmission2)
import Cardano.Network.Protocol.TxSubmission2.Type qualified as TxSubmission2
...
readCDDLSpecs = do
    dir <- bool (                        "protocols" </> "cddl" </> "specs") -- False
                ("cardano-diffusion" </> "protocols" </> "cddl" </> "specs") -- True
       <$> doesDirectoryExist ("cardano-diffusion" </> "protocols")
...
prop_encodePeerSharingV14ToLast spec (NtNVersionV14ToLast ntnVersion) =
  validateEncoder spec (codecPeerSharing ntnVersion)
